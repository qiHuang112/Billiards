...
import androidx.navigation.fragment.NoReplaceFragmentNavigator.Destination
...
public open class NoReplaceFragmentNavigator(
    ...
    private fun createFragmentTransaction(
        ...
        if (state.backStack.value.isNotEmpty()) {
            ft.hide(fragmentManager.fragments[state.backStack.value.lastIndex]).add(containerId, frag)
        } else {
    ...
    /**
     * NavDestination specific to [NoReplaceFragmentNavigator]
     *
     * Construct a new fragment destination. This destination is not valid until you set the
     * Fragment via [setClassName].
     *
     * @param fragmentNavigator The [NoReplaceFragmentNavigator] which this destination will be associated
    ...
    public constructor(fragmentNavigator: Navigator<out Destination>) :
        ...
        public constructor(navigatorProvider: NavigatorProvider) :
                this(navigatorProvider.getNavigator(NoReplaceFragmentNavigator::class.java))
