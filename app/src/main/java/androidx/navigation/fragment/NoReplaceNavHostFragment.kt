 ...
 */
public open class NoReplaceNavHostFragment : Fragment(), NavHost {
     ...
     * [NavHostController.setOnBackPressedDispatcher].
     *
     * By default, this adds a [DialogFragmentNavigator] and [NoReplaceFragmentNavigator].
     *
     ...
     * [NoReplaceFragmentNavigator], which replaces the entire contents of the NavHostFragment.
     *
     * This is only called once in [onCreate] and should not be called directly by
     * subclasses.
    ...
    protected open fun createFragmentNavigator(): Navigator<out NoReplaceFragmentNavigator.Destination> {
        return NoReplaceFragmentNavigator(requireContext(), childFragmentManager, containerId)
    }
    ...
    public companion object {
         ...
         * looking first for a [NoReplaceNavHostFragment] along the given Fragment's parent chain.
        ...
        public fun create(
            ...
            val result = NoReplaceNavHostFragment()
            if (b != null) {
                result.arguments = b
            }
            return result
